...
public class HiveJDBC {
  ...
  private static String url = "jdbc:hive2://node1:10000/";
  private static String user = "test_column";
  ...
  @Test
  public void selectSentryData() throws Exception {
    String sql = "select ip from sensitive.events";
    System.out.println("Running: " + sql);
    rs = stmt.executeQuery(sql);
    /*while (rs.next()) {
      System.out.println(rs.getString("ip") + "\t\t" + rs.getString("country") + "\t\t" + rs.getString("action"));
    }*/
  }
